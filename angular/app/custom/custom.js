...
$(document).ready(function(){
    $('.header-player_navigation .general-wrap-body').jScrollPane();

    $(document).on("click","#play-nav", function(){
        $(".button-close").addClass("button-close_active");
        $("#play-navigation").addClass("navigation_open");
        //$("#play-nav").toggleClass("navigation_active");
        $(".overlay").addClass("over-active");
    });
    $(document).on("click","#play-nav-close", function(){
        $("#play-nav-close").removeClass("button-close_active");
        $("#play-navigation").removeClass("navigation_open");
        $(".overlay").removeClass("over-active");
    });
