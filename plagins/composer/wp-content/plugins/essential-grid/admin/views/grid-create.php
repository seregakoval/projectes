				...
				<form id="eg-form-create-posts">
					<div class="eg-creative-settings">
						...
						<div class="eg-cs-tbc">
							...
							<p id="esg-source-choose-wrapper">
								...
								<input type="radio" name="source-type" value="custom" class="eg-tooltip-wrap" title="<?php _e('Items from the Media Gallery (Bulk Selection, Upload Possible), ', EG_TEXTDOMAIN); ?>"<?php echo checked($base->getVar($grid['postparams'], 'source-type', 'post'), 'custom'); ?>> <?php _e('Custom Grid (Editor Below)', EG_TEXTDOMAIN); ?>
							</p>
						</div>
					...
					<div class="divider1"></div>
						<div class="eg-creative-settings">
							...
							<div class="eg-cs-tbc">
								<p>
									<label for="post_types" ><?php _e('Post Types', EG_TEXTDOMAIN); ?></label>
								...
								<p id="eg-post-cat-wrap">
									<label for="source-code"><?php _e('Post Categories', EG_TEXTDOMAIN); ?></label>
									<?php
								...
								<p>
									...
									<div style="float: left">
										<input type="radio" value="OR" name="category-relation" <?php checked($base->getVar($grid['postparams'], 'category-relation', 'OR'), 'OR'); ?> class="firstinput eg-tooltip-wrap" title="<?php _e('Post need to be in one of the selected categories/tags', EG_TEXTDOMAIN); ?>"> <?php _e('OR', EG_TEXTDOMAIN); ?>
										<input type="radio" value="AND" name="category-relation" <?php checked($base->getVar($grid['postparams'], 'category-relation', 'OR'), 'AND'); ?> class="eg-tooltip-wrap" title="<?php _e('Post need to be in all categories/tags selected', EG_TEXTDOMAIN); ?>"> <?php _e('AND', EG_TEXTDOMAIN); ?>
									</div>
									<div style="clear: both;"></div>
								</p>
								<div id="eg-additional-post">
									<div style="float: left"><label for="additional-query"><?php _e('Additional Parameters', EG_TEXTDOMAIN); ?></label></div>
									<div style="float: left">
										<input type="text" name="additional-query" class="eg-tooltip-wrap eg-additional-parameters" title="<?php _e('Please use it like \'year=2012&monthnum=12\'', EG_TEXTDOMAIN); ?>" value="<?php echo $base->getVar($grid['postparams'], 'additional-query', ''); ?>" />
