	...
	<div class="postbox eg-postbox" style="width:100%;min-width:500px">
		...
		<div class="inside" style="display:none;padding:15px !important;margin:0px !important;height:100%;position:relative;background:#ebebeb">
			<p>
				...
				<input type="text" name="search-class[]" value="{{ data['search-class'] }}" class="eg-tooltip-wrap" title="<?php _e('Add CSS ID or Class here to trigger search as an onclick event on given elements (can be combined like \'.search, .search2, #search\')', EG_TEXTDOMAIN); ?>" />
			</p>
			<p>
