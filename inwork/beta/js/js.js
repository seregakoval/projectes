...
$(document).ready(function(){
    ...
    $(window).on('scroll', function(){
        if( $(window).scrollTop()>100 ){
            $('.header').addClass('animated fadeInDown').css({"box-shadow":"0 0 1px 2px rgba(0,0,0,0.25)","border-top":"3px solid #0773ba","background":"#fff",'position':"fixed"});
...
>>>>>>> 8aeb5be261cb7694a8984117dd8c6ef1b692baf1
