			...
			// select
				...
				var selectboxOutput = function() {
					...
					function doSelect() {
						...
						var selectbox =
							$('<div' + att.id + ' class="jq-selectbox jq-selectbox2 jqselect' + att.classes + '" style="display: inline-block; position: relative; z-index:' + singleSelectzIndex + '">' +
									'<div class="jq-selectbox__select select2 "' + att.title + ' style="position: relative">' +
										'<div class="jq-selectbox__select-text"></div>' +
										'<div class="jq-selectbox__trigger"><div class="jq-selectbox__trigger-arrow jq-selectbox__trigger-arrow2"></div></div>' +
									'</div>' +
								'</div>');
						...
						var dropdown =
							$('<div class="jq-selectbox__dropdown jq-selectbox__dropdown2" style="position: absolute">' +
									searchHTML +
