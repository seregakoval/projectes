...
BX.showWait = function(node, msg)
{
	...
	var obMsg = node.bxmsg = document.body.appendChild(BX.create('DIV', {
		...
		style: {
			background: 'url("wait.gif"/*tpa=http://demo.vsrt.ru/bitrix/js/main/core/images/wait.gif*/) no-repeat scroll 10px center #fcf7d1',
	...
	if (type == "icon")
	{
		element = BX.create('IMG', {
			props: {
				src: params.iconSrc
					? params.iconSrc
					: "hint.gif"/*tpa=http://demo.vsrt.ru/bitrix/js/main/core/images/hint.gif*/
			}
		});
	}
	else if (type == "link")
