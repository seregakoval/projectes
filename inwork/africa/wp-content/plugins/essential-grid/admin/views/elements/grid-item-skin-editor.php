						...
						<div class="eg-lc-menu-wrapper" style="height:100%;">
							...
							<div id="eg-lc-layout" class="esg-lc-settings-container active-esc">
								<div style="margin-top:15px">
									...
									<input type="radio" name="choose-layout" value="even" class="firstinput eg-tooltip-wrap" title="<?php _e('Each item gets Same Height. Width and Height are Item Ratio dependent.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($skin['params'], 'choose-layout', 'even'), 'even'); ?>> <?php _e('Even', EG_TEXTDOMAIN); ?>
									<input type="radio" name="choose-layout" value="masonry" class="eg-tooltip-wrap" title="<?php _e('Items height are depending on Media height and Content height.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($skin['params'], 'choose-layout', 'even'), 'masonry'); ?>> <?php _e('Masonry', EG_TEXTDOMAIN); ?>
								</div>
								<!-- MASONRY SETTINGS-->
								<div id="eg-show-content">
									<div style="margin-top:15px">
										<label style="float:left" class="eg-group-setter"><?php _e('Content', EG_TEXTDOMAIN); ?></label>
										<div class="select_wrapper" style="float:left;">
											...
											<select name="show-content" class="eg-tooltip-wrap" title="<?php _e('Position of Fixed Content', EG_TEXTDOMAIN); ?>">
										...
										<div class="select_wrapper" style="float:left;">
											<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
											<select name="content-align" class="eg-tooltip-wrap" title="<?php _e('Content Text Align Globaly', EG_TEXTDOMAIN); ?>">
								...
								<div id="eg-show-ratio" >
									<p>
										...
										<span id="element-x-ratio" class="slider-settings eg-tooltip-wrap" title="<?php _e('Width Ratio of Item.', EG_TEXTDOMAIN); ?>"></span> <input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Width Ratio of Item.', EG_TEXTDOMAIN); ?>" type="text" name="element-x-ratio" value="<?php echo $base->getVar($skin['params'], 'element-x-ratio', 4, 'i'); ?>" />
									</p>
									<p>
										<label style="float:left" class="eg-group-setter"><?php _e('Ratio Y', EG_TEXTDOMAIN); ?></label>
										<span id="element-y-ratio" class="slider-settings eg-tooltip-wrap" title="<?php _e('Height Ratio of Item.', EG_TEXTDOMAIN); ?>"></span> <input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Height Ratio of Item.', EG_TEXTDOMAIN); ?>" type="text" name="element-y-ratio" value="<?php echo $base->getVar($skin['params'], 'element-y-ratio', 3, 'i'); ?>" />
									</p>
								</div>
							...
							<div id="eg-lc-cover" class="esg-lc-settings-container">
								<!-- COVER LAYOUT -->
								<div style="margin-top:15px">
									<label style="float:left" class="eg-group-setter"><?php _e('Cover Type', EG_TEXTDOMAIN); ?></label>
									<div class="select_wrapper" style="float:left;">
										<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
										<select name="cover-type" class="eg-tooltip-wrap" title="<?php _e('Dynamic Covering Content Type. Show Cover Background on full Media, or only under Cover Contents ?', EG_TEXTDOMAIN); ?>">
								...
								<p>
									...
									<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Cover Background Color opacity', EG_TEXTDOMAIN); ?>" type="text" name="element-container-background-color-opacity" value="<?php echo $base->getVar($skin['params'], 'element-container-background-color-opacity', '85', 'i'); ?>" />
								</p>
							...
							<div id="eg-lc-spaces" class="esg-lc-settings-container">
								...
								<div id="eg-style-full">
									...
									<div style="margin-top:15px">
										<label><?php _e('Item BG Color', EG_TEXTDOMAIN); ?></label>
										<input class="element-setting eg-tooltip-wrap" title="<?php _e('Background Color of Full Item', EG_TEXTDOMAIN); ?>" name="full-bg-color" type="text" id="full-bg-color" value="<?php echo $base->getVar($skin['params'], 'full-bg-color', '#ffffff'); ?>" data-default-color="#ffffff">
									</div>
									<p>
										<?php
										$padding = $base->getVar($skin['params'], 'full-padding');
										?>
										<label><?php _e('Item Paddings', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Padding of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-padding[]" value="<?php echo (isset($padding[0])) ? $padding[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Padding of Item', EG_TEXTDOMAIN); ?>"  type="text" name="full-padding[]" value="<?php echo (isset($padding[1])) ? $padding[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Padding of Item', EG_TEXTDOMAIN); ?>"  type="text" name="full-padding[]" value="<?php echo (isset($padding[2])) ? $padding[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Padding of Item', EG_TEXTDOMAIN); ?>"  type="text" name="full-padding[]" value="<?php echo (isset($padding[3])) ? $padding[3] : 0; ?>" /> px
									</p>
									<p>
										<?php
										$border = $base->getVar($skin['params'], 'full-border');
										?>
										<label><?php _e('Item Border', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Border Width of Item', EG_TEXTDOMAIN); ?>"  type="text" name="full-border[]" value="<?php echo (isset($border[0])) ? $border[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Border Width of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border[]" value="<?php echo (isset($border[1])) ? $border[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Border Width of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border[]" value="<?php echo (isset($border[2])) ? $border[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Border Width of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border[]" value="<?php echo (isset($border[3])) ? $border[3] : 0; ?>" /> px
									</p>
									<p>
										<?php
										$radius = $base->getVar($skin['params'], 'full-border-radius');
										?>
										<label><?php _e('Border Radius', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Left Border Radius of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border-radius[]" value="<?php echo (isset($radius[0])) ? $radius[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Top Right Border Radius of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border-radius[]" value="<?php echo (isset($radius[1])) ? $radius[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Right Border Radius of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border-radius[]" value="<?php echo (isset($radius[2])) ? $radius[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Left Border Radius of Item', EG_TEXTDOMAIN); ?>" type="text" name="full-border-radius[]" value="<?php echo (isset($radius[3])) ? $radius[3] : 0; ?>" /> px
									</p>
									<p>
									...
									<div style="margin-top:10px">
										...
										<div class="select_wrapper" style="float:left;">
											<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
											<select name="full-border-style" class="eg-tooltip-wrap" title="<?php _e('Border Line Style', EG_TEXTDOMAIN); ?>">
									...
									<p>
										...
										<input type="radio" name="full-overflow-hidden" value="true" class="firstinput eg-tooltip-wrap" title="<?php _e('Hide Overflow (fix border radius issues)', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($skin['params'], 'full-overflow-hidden', 'false'), 'true'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
										<input type="radio" name="full-overflow-hidden" value="false" class="eg-tooltip-wrap" title="<?php _e('Show Overflowed content', EG_TEXTDOMAIN); ?>"<?php checked($base->getVar($skin['params'], 'full-overflow-hidden', 'false'), 'false'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
									</p>
								</div>
								<div id="eg-style-content" style="display:none">
									...
									<p>
										...
										?>
										<label><?php _e('Content Paddings', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Padding of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-padding[]" value="<?php echo (isset($padding[0])) ? $padding[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Padding of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-padding[]" value="<?php echo (isset($padding[1])) ? $padding[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Padding of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-padding[]" value="<?php echo (isset($padding[2])) ? $padding[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Padding of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-padding[]" value="<?php echo (isset($padding[3])) ? $padding[3] : 0; ?>" /> px
									</p>
									<p>
										<?php
										$border = $base->getVar($skin['params'], 'content-border');
										?>
										<label><?php _e('Content Border', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Border Width of Fix Content', EG_TEXTDOMAIN); ?>"  type="text" name="content-border[]" value="<?php echo (isset($border[0])) ? $border[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Border Width of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border[]" value="<?php echo (isset($border[1])) ? $border[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Border Width of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border[]" value="<?php echo (isset($border[2])) ? $border[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Border Width of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border[]" value="<?php echo (isset($border[3])) ? $border[3] : 0; ?>" /> px
									</p>
									<p>
										<?php
										...
										?>
										<label><?php _e('Border Radius', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Left Border Radius of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border-radius[]" value="<?php echo (isset($radius[0])) ? $radius[0] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Top Right Border Radius of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border-radius[]" value="<?php echo (isset($radius[1])) ? $radius[1] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Right Border Radius of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border-radius[]" value="<?php echo (isset($radius[2])) ? $radius[2] : 0; ?>" />
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Left Border Radius of Fix Content', EG_TEXTDOMAIN); ?>" type="text" name="content-border-radius[]" value="<?php echo (isset($radius[3])) ? $radius[3] : 0; ?>" /> px
									</p>
									<p>
										<label><?php _e('Border Color', EG_TEXTDOMAIN); ?></label>
									...
									<div style="margin-top:10px">
										...
										<div class="select_wrapper" style="float:left;">
											<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
											<select name="content-border-style" class="eg-tooltip-wrap" title="<?php _e('Border Line Style', EG_TEXTDOMAIN); ?>">
							...
							<div id="eg-lc-content-shadow" class="esg-lc-settings-container ">
								<div style="margin-top:15px">
									<label style="float:left"><?php _e('Use Shadow', EG_TEXTDOMAIN); ?></label>
									<div class="select_wrapper" style="float:left;">
										<?php
										$shadow_type = $base->getVar($skin['params'], 'all-shadow-used', 'none');
										?>
										<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
										<select name="all-shadow-used" class="eg-tooltip-wrap" title="<?php _e('Drop Shadow of Element(s)', EG_TEXTDOMAIN); ?>">>
								...
								<p>
									...
									<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Shadow Opacity', EG_TEXTDOMAIN); ?>" type="text" name="content-shadow-alpha" value="<?php echo $base->getVar($skin['params'], 'content-shadow-alpha', '100', 'i'); ?>" />
								</p>
								<p>
									<?php
									...
									<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('The position of the horizontal shadow. Negative values are allowed', EG_TEXTDOMAIN); ?>" type="text" name="content-box-shadow[]" value="<?php echo (isset($shadow[0])) ? $shadow[0] : 0; ?>" />
									<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The position of the vertical shadow. Negative values are allowed', EG_TEXTDOMAIN); ?>" type="text" name="content-box-shadow[]" value="<?php echo (isset($shadow[1])) ? $shadow[1] : 0; ?>" />
									<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The blur distance', EG_TEXTDOMAIN); ?>" type="text" name="content-box-shadow[]" value="<?php echo (isset($shadow[2])) ? $shadow[2] : 0; ?>" />
									<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The size of shadow', EG_TEXTDOMAIN); ?>" type="text" name="content-box-shadow[]" value="<?php echo (isset($shadow[3])) ? $shadow[3] : 0; ?>" /> px
								</p>
							...
							<div id="eg-lc-content-animation" class="esg-lc-settings-container ">
									...
									<div style="float:left">
										...
										<div id="eg-cover-animation-top">
											...
											<div class="select_wrapper" style="float:right;">
												...
												<select name="cover-animation-top-type" style="width: 70px;" class="eg-tooltip-wrap" title="<?php _e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', EG_TEXTDOMAIN); ?>">
												...
												<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before the Animation starts', EG_TEXTDOMAIN); ?>" type="text" name="cover-animation-delay-top" value="<?php echo $base->getVar($skin['params'], 'cover-animation-delay-top', '0', 'i'); ?>" />
											</div>
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="cover-animation-top" class="eg-tooltip-wrap" title="<?php _e('Animation Effect on Cover', EG_TEXTDOMAIN); ?>">
													<?php
										...
										<div id="eg-cover-animation-center">
											...
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake" style="width: 40px;overflow: hidden;white-space: nowrap;"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="cover-animation-center-type" style="width: 70px;" class="eg-tooltip-wrap" title="<?php _e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', EG_TEXTDOMAIN); ?>">
												...
												<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before the Animation starts', EG_TEXTDOMAIN); ?>" type="text" name="cover-animation-delay-center" value="<?php echo $base->getVar($skin['params'], 'cover-animation-delay-center', '0', 'i'); ?>" />
											</div>
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="cover-animation-center" class="eg-tooltip-wrap" title="<?php _e('Animation Effect on Cover', EG_TEXTDOMAIN); ?>">
													<?php
													foreach($transitions_cover as $handle => $name){
													?>
										...
										<div id="eg-cover-animation-bottom">
											...
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake" style="width: 40px;overflow: hidden;white-space: nowrap;"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="cover-animation-bottom-type" style="width: 70px;" class="eg-tooltip-wrap" title="<?php _e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', EG_TEXTDOMAIN); ?>">
												...
												<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before the Animation starts', EG_TEXTDOMAIN); ?>" type="text" name="cover-animation-delay-bottom" value="<?php echo $base->getVar($skin['params'], 'cover-animation-delay-bottom', '0', 'i'); ?>" />
											</div>
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="cover-animation-bottom" class="eg-tooltip-wrap" title="<?php _e('Animation Effect on Cover', EG_TEXTDOMAIN); ?>">
													<?php
													foreach($transitions_cover as $handle => $name){
													?>
								...
								<!-- GROUP ANIMATION -->
								<div style="margin-top:15px">
									<label style="float:left; width:150px" class="eg-group-setter"><?php _e('Group Animation', EG_TEXTDOMAIN); ?></label>
									<div class="select_wrapper" style="float:left;">
										<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
										<select name="cover-group-animation" class="eg-tooltip-wrap" title="<?php _e('Animation Effect on Cover and on All Cover elements Grouped. This will not replace the Animation but add a global animation extra.', EG_TEXTDOMAIN); ?>">
											<?php
											foreach($transitions_cover as $handle => $name){
											?>
								...
								<!-- MEDIA ANIMATION -->
								<div style="margin-top:15px">
									<label style="float:left; width:150px;"><?php _e('Media Animation', EG_TEXTDOMAIN); ?></label>
									<div class="select_wrapper" style="float:left;">
										<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
										<select name="media-animation" class="eg-tooltip-wrap" title="<?php _e('Animation of Media on Hover. All Media animation hide, or partly hide the Media on hover.', EG_TEXTDOMAIN); ?>">
											<?php
										...
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before the Animation starts', EG_TEXTDOMAIN); ?>" type="text" name="media-animation-delay" value="<?php echo $base->getVar($skin['params'], 'media-animation-delay', '0', 'i'); ?>" />
									</div>
									<div class="clear"></div>
								</div>
							</div>
							...
							<div id="eg-lc-content-link-seo" class="esg-lc-settings-container">
								<div style="margin-top:15px">
									<label style="float:left; width:150px;"><?php _e('Add Link To', EG_TEXTDOMAIN); ?></label>
									<div class="select_wrapper" style="float:left;">
										<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
										<?php $link_set_to = $base->getVar($skin['params'], 'link-set-to', 'none'); ?>
										<select name="link-set-to" class="eg-tooltip-wrap" title="<?php _e('Choose where the following link should be appended to.', EG_TEXTDOMAIN); ?>">
						...
						<form id="eg-item-element-settings-wrap">
							<div id="settings-dz-elements-wrapper" class="eg-ul-tabs">
								...
								<div id="eg-element-source">
									<div id="dz-source">
										<div style="margin-top:10px" class="eg-hide-on-special eg-hide-on-blank-element">
											<label style="float:left"><?php _e('Source', EG_TEXTDOMAIN); ?></label>
											<div class="select_wrapper" style="float:left;">
												<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
												<select name="element-source" style="width:180px" class="eg-tooltip-wrap" title="<?php _e('Select The Source of this Element', EG_TEXTDOMAIN); ?>">
													<?php
										...
										<div style="margin-top:10px">
											<div id="eg-source-element-drops" class="eg-hide-on-special eg-hide-on-blank-element">
												...
												<label style="float:left"><?php _e('Element', EG_TEXTDOMAIN); ?></label>
													...
													foreach($element_type as $el_cat => $el_type){
														...
														<div class="select_wrapper" style="float:left;">
															<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
															<select name="element-source-<?php echo $el_cat; ?>" style="width:180px" class="elements-select-wrap eg-tooltip-wrap" title="<?php _e('Narrow down your selection', EG_TEXTDOMAIN); ?>">
																<?php
												...
												<div id="eg-source-seperate-wrap" style="margin-top:10px;line-height:25px">
													<label style="float: left"><?php _e('Separate By', EG_TEXTDOMAIN); ?></label>
													<input type="text" value="" name="element-source-separate" class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Separator Char in the Listed element', EG_TEXTDOMAIN); ?>">
													<div class="clear"></div>
												</div>

												<!-- CAT & TAG CHOOSE TYPE -->
												<div id="eg-source-functonality-wrap" style="margin-top:10px;line-height:25px">
													<label style="float: left"><?php _e('On Click', EG_TEXTDOMAIN); ?></label>
													<div class="select_wrapper" style="float:left;">
														<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
														<select name="element-source-function" style="width:180px" class="elements-select-wrap eg-tooltip-wrap" title="<?php _e('Narrow down your selection', EG_TEXTDOMAIN); ?>">
												...
												<div id="eg-source-meta-wrap" style="margin-top:10px;line-height:25px">
													<label style="float: left"><?php _e('Meta Key', EG_TEXTDOMAIN); ?></label>
													<input type="text" value="" name="element-source-meta" class="input-settings element-setting firstinput eg-tooltip-wrap" title="<?php _e('The Handle or ID of Meta Key', EG_TEXTDOMAIN); ?>">
												...
												<div id="eg-source-limit-wrap" style="margin-top:10px;line-height:25px">
													...
													<div class="select_wrapper" style="float:left;">
														...
														<select name="element-limit-type" class="eg-tooltip-wrap" title="<?php _e('Text Length Limitation calculated based on...', EG_TEXTDOMAIN); ?>">
															<option value="none"><?php _e('None', EG_TEXTDOMAIN); ?></option>
													...
													<input style="float:left; margin-left:10px;" type="text" value="" name="element-limit-num" class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Max visible amount of Chars or  Words', EG_TEXTDOMAIN); ?>">
											...
											<div id="eg-source-text-style-disable-wrap" class="elements-select-wrap eg-hide-on-special eg-hide-on-blank-element">
												<label style="float: left"><?php _e('Disable Styling', EG_TEXTDOMAIN); ?></label>
												<div style="float: left; margin-top: 5px;"><input type="checkbox" name="element-source-text-style-disable" class="input-settings element-setting firstinput eg-tooltip-wrap" value="on" title="<?php _e('Stylings will not be written', EG_TEXTDOMAIN); ?>"></div>
											</div>
									...
									<div id="eg-styling-idle-hover-tab" class="eg-ul-tabs">
										...
										<div id="eg-style-idle">
											...
											<div id="eg-el-pos" class="esg-el-settings-container">
												...
												<p>
													...
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top', EG_TEXTDOMAIN); ?>" type="text" name="element-margin[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right', EG_TEXTDOMAIN); ?>" type="text" name="element-margin[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom', EG_TEXTDOMAIN); ?>" type="text" name="element-margin[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left', EG_TEXTDOMAIN); ?>" type="text" name="element-margin[]" value="0" /> px
												</p>
												<p>
													<label><?php _e('Paddings', EG_TEXTDOMAIN); ?></label>
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top', EG_TEXTDOMAIN); ?>" type="text" name="element-padding[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right', EG_TEXTDOMAIN); ?>" type="text" name="element-padding[]" value="0" />
											...
											<div id="eg-el-shadow" class="esg-el-settings-container">
												...
												<p>
													<label><?php _e('Shadow', EG_TEXTDOMAIN); ?></label>
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('The position of the horizontal shadow. Negative values are allowed', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The position of the vertical shadow. Negative values are allowed', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The blur distance', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The size of shadow', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow[]" value="0" /> px
												</p>
												<div class="drop-to-stylechange eg-tooltip-wrap" title="<?php _e('Drop Element from Available Layers here to overwrite Styling of Current Element', EG_TEXTDOMAIN); ?>"><?php _e("Drop for<br>Style<br>Change", EG_TEXTDOMAIN); ?></div>
											</div>
											...
											<div id="eg-el-border" class="esg-el-settings-container">
												<p>
													...
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border[]" value="0" /> px
												</p>
												<div style="margin-top:10px">
													<label style="float:left"><?php _e('Border Radius', EG_TEXTDOMAIN); ?></label>
													<input style="float:left" class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Left Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Top Right Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Right Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Left Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius[]" value="0" />
													<div class="select_wrapper" style="float:left; width:40px;margin-left:15px;">
														<div class="select_fake" style="width: 40px;overflow: hidden;white-space: nowrap;"><span>px</span><i class="eg-icon-sort"></i></div>
										...
										<div id="eg-style-hover">
											...
											<div id="eg-el-shadow-hover" class="esg-el-settings-container">
												...
												<p>
													<label><?php _e('Shadow', EG_TEXTDOMAIN); ?></label>
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('The position of the horizontal shadow. Negative values are allowed', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The position of the vertical shadow. Negative values are allowed', EG_TEXTDOMAIN) ?>"  type="text" name="element-box-shadow-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The blur distance', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('The size of Shadow', EG_TEXTDOMAIN) ?>" type="text" name="element-box-shadow-hover[]" value="0" /> px
												</p>
												<div class="revyellow drop-to-stylereset button-primary"><i class="eg-icon-ccw-1"></i><?php _e("Reset from Idle", EG_TEXTDOMAIN); ?></div>
											</div>
											...
											<div id="eg-el-border-hover" class="esg-el-settings-container">
												...
												<p>
													<label><?php _e('Border', EG_TEXTDOMAIN); ?></label>
													<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Right Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border-hover[]" value="0" />
													<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Left Border Width', EG_TEXTDOMAIN) ?>" type="text" name="element-border-hover[]" value="0" /> px
												</p>
												<div style="margin-top:10px">
													<label style="float:left"><?php _e('Border Radius', EG_TEXTDOMAIN); ?></label>
													<input style="float:left" class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Top Left Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius-hover[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Top Right Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius-hover[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Right Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius-hover[]" value="0" />
													<input style="float:left" class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Bottom Left Radius', EG_TEXTDOMAIN) ?>" type="text" name="element-border-radius-hover[]" value="0" />
													<div class="select_wrapper" style="float:left; width:40px;margin-left:15px;">
														<div class="select_fake" style="width: 40px;overflow: hidden;white-space: nowrap;"><span>px</span><i class="eg-icon-sort"></i></div>
								...
								<div id="eg-element-hide">
									<p>
										<label style="width:250px"><?php _e('Hide Under Width', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Dont Show Element if Item Width is smaller than:', EG_TEXTDOMAIN); ?>" type="text" name="element-hideunder" value="0" /> px
									</p>
									<p>
										<label style="width:250px"><?php _e('Hide Under Height', EG_TEXTDOMAIN); ?></label>
										<input class="input-settings-small element-setting firstinput eg-tooltip-wrap" title="<?php _e('Dont Show Element on mobile if Item height is smaller than:', EG_TEXTDOMAIN); ?>" type="text" name="element-hideunderheight" value="0" /> px
									</p>
									<div style="margin-top:10px">
									...
									<p>
										<label style="width:250px"><?php _e('Hide if Media is Video', EG_TEXTDOMAIN); ?></label>
										<input type="checkbox" name="element-hide-on-video" title="<?php _e('Dont Show Element if the Media this Entry gains is a Video', EG_TEXTDOMAIN); ?>"  value="true" />
									</p>
									<?php
									...
									?>
									<p>
										<label style="width:250px"><?php _e('Show if Product is on Sale', EG_TEXTDOMAIN); ?></label>
										<input type="checkbox" name="element-show-on-sale" title="<?php _e('Show the Element only if it is on Sale. This is a WooCommerce setting', EG_TEXTDOMAIN); ?>"  value="true" />
									</p>
									<p>
										<label style="width:250px"><?php _e('Show if Product is featured', EG_TEXTDOMAIN); ?></label>
										<input type="checkbox" name="element-show-if-featured" title="<?php _e('Show the Element only if it is featured. This is a WooCommerce setting', EG_TEXTDOMAIN); ?>"  value="true" />
									</p>
									<?php
									if(!Essential_Grid_Woocommerce::is_woo_exists()){
										echo '</div>';
								...
								<div id="eg-element-animation">
									...
									<p>
										...
										<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before Element Animation starts', EG_TEXTDOMAIN) ?>" type="text" name="element-delay" value="0" />
									</p>
								</div>
								<!--
								LINK TO
