				...
				<div class="eg-creative-settings" id="eg-cobbles-options">
					...
					<div class="eg-cs-tbc" style="padding-bottom:15px;">
						<p>
							...
							<input type="radio" name="use-cobbles-pattern" value="on" class="firstinput eg-tooltip-wrap" title="<?php _e('User cobbles pattern', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'use-cobbles-pattern', 'off'), 'on'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
							<input type="radio" name="use-cobbles-pattern" value="off" class="eg-tooltip-wrap" title="<?php _e('User specific set cobbles setting from entries', EG_TEXTDOMAIN); ?>"<?php checked($base->getVar($grid['params'], 'use-cobbles-pattern', 'off'), 'off'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
						</p>
					...
					<div class="eg-cs-tbc">
						<table style="position:relative">
							...
							<tr id="eg-col-1">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on large desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px; width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[0]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for large desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[0]; ?>">
							...
							<tr id="eg-col-2">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on medium sized desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[1]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for medium sized desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[1]; ?>">
							...
							<tr id="eg-col-3">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on small sized desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[2]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for small sized desktop screens', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[2]; ?>">
							...
							<tr id="eg-col-4">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on tablets in landscape view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[3]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for tablets in landscape view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[3]; ?>">
							...
							<tr id="eg-col-5">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on tablets in portrait view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[4]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for tablets in portrait view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[4]; ?>">
							...
							<tr id="eg-col-6">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on mobiles in landscape view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[5]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for mobiles in landscape view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-width[]" value="<?php echo $columns_width[5]; ?>">
							...
							<tr id="eg-col-7">
								...
								<td>
									<input class="input-settings-small columns-height firstinput eg-tooltip-wrap" title="<?php _e('Start height for Grid on mobiles in portrait view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text" name="columns-height[]" value="<?php echo $columns_height[6]; ?>">
									<input class="input-settings-small columns-width firstinput eg-tooltip-wrap" title="<?php _e('Min. browser width for mobiles in portrait view', EG_TEXTDOMAIN); ?>" style="margin-right:15px;width:100px" type="text"  name="columns-width[]" value="<?php echo $columns_width[6]; ?>">
			...
			<div class="">
				...
				*/ ?>
				...
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc">
						<p>
							...
							<input type="radio" name="pagination-numbers" value="smart" class="firstinput eg-tooltip-wrap" title="<?php _e('Will show pagination like: 1 2 ... 5 6', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'pagination-numbers', 'smart'), 'smart'); ?>> <?php _e('Smart', EG_TEXTDOMAIN); ?>
							<input type="radio" name="pagination-numbers" value="full" class="eg-tooltip-wrap" title="<?php _e('Will show full pagination like: 1 2 3 4 5 6', EG_TEXTDOMAIN); ?>"<?php checked($base->getVar($grid['params'], 'pagination-numbers', 'smart'), 'full'); ?>> <?php _e('Full', EG_TEXTDOMAIN); ?>
						</p>
						<p>
						...
						<p>
							<label for="pagination-scroll-offset"><?php _e('Scroll To Offset', EG_TEXTDOMAIN); ?></label>
				...
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc" style="padding-bottom: 10px;">
						...
						<p class="eg-filter-start">
							<label for="filter-start"><?php _e('Start with Filter', EG_TEXTDOMAIN); ?></label>
							<input type="text" name="filter-start" value="<?php echo $base->getVar($grid['params'], 'filter-start', ''); ?>" class="firstinput eg-tooltip-wrap" title="<?php _e('Start filtering by this filter (use the handle/slug of filter), leave empty to disable. More than one filter are possible by comma separating them.', EG_TEXTDOMAIN); ?>">
						</p>
						<p>
							<label for="filter-show-on"><?php _e('Dropdown Elements on', EG_TEXTDOMAIN); ?></label>
							<input type="radio" name="filter-show-on" value="click" class="firstinput eg-tooltip-wrap" title="<?php _e('Filter in Dropdown will be shown on click', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'filter-show-on', 'hover'), 'click'); ?>> <?php _e('Click', EG_TEXTDOMAIN); ?>
							<input type="radio" name="filter-show-on" value="hover" class="eg-tooltip-wrap" title="<?php _e('Filter in Dropdown will be shown on hover', EG_TEXTDOMAIN); ?>"<?php checked($base->getVar($grid['params'], 'filter-show-on', 'hover'), 'hover'); ?>> <?php _e('Hover', EG_TEXTDOMAIN); ?>
						</p>
				...
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc">
						<p>
							<label for="search-text"><?php _e('Search Default Text', EG_TEXTDOMAIN); ?></label>
							<input type="text" name="search-text" class="eg-tooltip-wrap" title="<?php _e('Placeholder text of input field', EG_TEXTDOMAIN); ?>" value="<?php echo $base->getVar($grid['params'], 'search-text', __('Search...', EG_TEXTDOMAIN)); ?>" class="firstinput">
						</p>
					</div>
				</div>
				...
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc">
						<p>
							...
							?>
							<label for="lightbox-mode"><?php _e('Gallery Mode', EG_TEXTDOMAIN); ?></label>
						...
						<p class="lightbox-mode-addition-wrapper"<?php echo ($lighbox_mode == 'content' || $lighbox_mode == 'content-gallery' || $lighbox_mode == 'woocommerce-gallery') ? '' : ' style="display: none;"'; ?>>
							...
							<input type="radio" name="lightbox-exclude-media" value="on" class="firstinput eg-tooltip-wrap" title="<?php _e('Exclude original media from Source Order', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'lightbox-exclude-media', 'off'), 'on'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
							<input type="radio" name="lightbox-exclude-media" value="off" class="eg-tooltip-wrap" title="<?php _e('Include original media from Source Order', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'lightbox-exclude-media', 'off'), 'off'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
						</p>
					</div>
				</div>
				<div class="divider1"></div>
		...
		<div id="esg-settings-cookie-settings" class="esg-settings-container">
			<div class="">
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc">
						<p>
							<label for="filter-arrows" ><?php _e('Save for', EG_TEXTDOMAIN); ?></label>
							<input type="text" name="cookie-save-time" class="input-settings-small firstinput eg-tooltip-wrap" title="<?php _e('The amount of time before the cookies expire (in minutes).', EG_TEXTDOMAIN); ?>" value="<?php echo intval($base->getVar($grid['params'], 'cookie-save-time', '30')); ?>"> <?php _e('Minutes', EG_TEXTDOMAIN); ?>
						</p>
						<div style="width:100%;height:15px"></div>
					</div>
				</div>
				...
				<div class="eg-creative-settings">
					...
					<div class="eg-cs-tbc">
						<p>
							...
							<input type="radio" name="cookie-save-search" value="on" class="firstinput eg-tooltip-wrap" title="<?php _e('Remember user\'s last search.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-search', 'off'), 'on'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
							<input type="radio" name="cookie-save-search" value="off" class="eg-tooltip-wrap" title="<?php _e('Do not apply cookie for search.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-search', 'off'), 'off'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
						</p>
						<p>
							<label for="filter-arrows" ><?php _e('Filter', EG_TEXTDOMAIN); ?></label>
							<input type="radio" name="cookie-save-filter" value="on" class="firstinput eg-tooltip-wrap" title="<?php _e('Remember Grid\'s last filter state.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-filter', 'off'), 'on'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
							<input type="radio" name="cookie-save-filter" value="off" class="eg-tooltip-wrap" title="<?php _e('Do not apply cookie for filter.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-filter', 'off'), 'off'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
						</p>
						<p>
							<label for="filter-arrows" ><?php _e('Pagination', EG_TEXTDOMAIN); ?></label>
							<input type="radio" name="cookie-save-pagination" value="on" class="firstinput eg-tooltip-wrap" title="<?php _e('Remember Grid\'s last pagination state.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-pagination', 'off'), 'on'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
							<input type="radio" name="cookie-save-pagination" value="off" class="eg-tooltip-wrap" title="<?php _e('Do not apply cookie for pagination.', EG_TEXTDOMAIN); ?>" <?php checked($base->getVar($grid['params'], 'cookie-save-pagination', 'off'), 'off'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
						</p>
						<p class="esg-note">
