	...
	<tr>
		<td width="50%" valign="top">
			<table width="100%" cellpadding="3" cellspacing="1">
				...
				<tr>
					<td rowspan="10" nowrap><img src="<?php echo SF_PLUGIN_URL; ?>/images/blank.gif" width="20" height="1"></td>
		...
		<td><img src="<?php echo SF_PLUGIN_URL; ?>/images/blank.gif" width="20" height="1"></td>
