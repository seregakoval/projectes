...
class SF_Ajax {
	...
	public function get_individual_results(){
		include_once(WP_PLUGIN_DIR.'/'.SF_PLUGIN_DIR.'/classes/sf_individual_result_class.php');
		...
		include WP_PLUGIN_DIR.'/'.SF_PLUGIN_DIR.'/form_templates/results_individual.php';
		die();
	}
}
