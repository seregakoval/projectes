...
if ( 'true' != pb_backupbuddy::_GET( 'listAll' ) ) {
	$listAll = '<small>[<a href="' . pb_backupbuddy::ajax_url( 'remoteClient' ) . '&destination_id=' . htmlentities( pb_backupbuddy::_GET( 'destination_id' ) ) . '&listAll=true">List all files (not just this site)</a>]</small>';
} else {
