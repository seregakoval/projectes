...
{	
	...
	function output_hello_t_banner()
	{
		...
		echo '<h3><strong>Need more Testimonials? We can help.</strong></h3>
				<p><strong>Hello Testimonials</strong> is our new system that helps you get more testimonials automatically. You simply add your customers to the system as you go, and they\'ll receive a personalized email asking them to leave a testimonial, with a link to a personalized form.</p><p>As new testimonials are collected and approved by you, they\'ll be displayed on your websites automatically.</p><p>We\'re offering a 14-Day Free Trial of Hello Testimonials to users of Easy Testimonials, so give it a try!</p><p><a class="smallBlueButton" href="http://hellotestimonials.com/p/welcome-easy-testimonials-users/" title="Start Your Free Trial">Start Your Free Trial &raquo;</a></p>
				<br/>';
		echo "</div>";
