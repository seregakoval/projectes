		...
		$style = array(
			...
			'content' => array(
				...
				'mod_options' => array(
					'fields' => array(
						'title' => array(
							'name' => __('Title',OP_SN),
							'default' => __('Discover How You Can Build Pages Just Like This In Seconds...',OP_SN),
						),
						'content' => array(
							'name' => __('Content',OP_SN),
							'default' => __('Your high impact sub-headline or call to action text would be placed here.  Enter your name and email below for instant access',OP_SN),
							'type' => 'wysiwyg',
							'disable_font' => true
						)
					),
			...
			'footer_note' => array(
				...
				'mod_options' => array(
					'fields' => array(
						'footer_note' => array(
							'name' => __('Footer Note',OP_SN),
							'default' => __('We value your privacy. Your information will never be shared or sold.',OP_SN),
