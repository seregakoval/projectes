...
class OptimizePress_Page_Feature_Area extends OptimizePress_Page_Feature_Area_Base {
	...
	function __construct(){
		...
		add_filter('op_page_feature_area_marketing_selection',array($this,'style_selector'),10,2);
		parent::__construct();
	}
	...
	function get_options(){
		...
		$fields = array(
			'title' => array(
				...
				'default' => __('The perfect way to convert your traffic into sales',OP_SN),
			),
			'paragraph' => array(
				'name' => __('Content',OP_SN),
				'help' => __('Enter the sub title/message text above your submit button',OP_SN),
				'type' => 'wysiwyg',
				'default' => __('Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.<br />Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum.',OP_SN),
				'disable_font' => true,
			),
			'submit_button' => array(
		...
		$img_fields = array(
			'image' => array(
				'name' => __('Image',OP_SN),
				'help' => __('Enter the URL to the image',OP_SN),
					...
					'mod_options' => array(
						'fields' => array(
							...
							'subtitle' => array(
								...
								'help' => __('Enter the sub title to be displayed at the top of the content area',OP_SN),
								'default' => __('The perfect way to convert your traffic into sales',OP_SN),
							),
						)
					),
