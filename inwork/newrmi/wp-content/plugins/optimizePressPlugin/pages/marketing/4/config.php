...
$config['name'] = __('Template Style 4 - Raised Header', OP_SN);
$config['screenshot'] = 'styles/ms-4b.jpg';
$config['screenshot_thumbnail'] = 'styles/ms-4b.jpg';
$config['description'] = __('This design includes the raised header for giving header banners more impact', OP_SN);
$config['header_width'] = 1026;
