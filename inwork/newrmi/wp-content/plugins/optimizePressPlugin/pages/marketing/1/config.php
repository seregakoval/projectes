...
$config['name'] = __('Template Style 1 - Full-Width', OP_SN);
$config['screenshot'] = 'styles/ms-1b.jpg';
$config['screenshot_thumbnail'] = 'styles/ms-1b.jpg';
$config['description'] = __('This borderless template is perfect for clean designs with lots of white space', OP_SN);
