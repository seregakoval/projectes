...
class OptimizePress_Sections_Functionality {
	...
	static function sections(){
		...
		$defaults = array(
			...
			/*'fb_share' => array(
				'title' => __('Facebook Share Settings', OP_SN),
