var op_asset_settings = (function($){
	return {
		...
		customInsert: function(attrs){
			...
			str = '[img_text_aside style="' + style + '" image="' + image + '" image_alignment="' + image_alignment + '" headline="' + headline + '" text="' + text.replace(/"/g, '\'') + '" alignment="' + alignment + '"][/img_text_aside]';
		...
		customSettings: function(attrs,steps){
			...
			var style = attrs.style || 1,
				...
				text = op_decodeURIComponent(attrs.text),
				alignment = attrs.alignment,
				preview_html = '';
