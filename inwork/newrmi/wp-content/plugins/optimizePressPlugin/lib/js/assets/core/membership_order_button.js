        ...
        attributes: {
            ...
            step_3: {
                ...
                want_to_charge: {
                    ...
                    default_value: '0.01',
                    showOn: {field:'step_3.gateway',value:['alipay', 'authnet', 'google', 'paypal'], displayType: 'inline-block'},
                },
                one_time_auth: {
                    title: 'one_time_auth',
                    type: 'select',
                ...
                currency_new: {
                    ...
                    default_value: 'USD',
                    showOn: {field:'step_3.gateway', value: ['google', 'paypal']}
                },
                success_url: {
                    title: 'success_url',
                    showOn: {field: 'step3.gateway', value: 'paypal', displayType: 'inline-block'}
                },
                first_cc: {
                    title: 'first',
        ...
        customInsert: function (attrs) {
            var str = '',
                ...
                nonButtonFields = [
                    ...
                    'click_skin', 'click_fid', 'click_ur', 'click_f'
                ];
            ...
            for (var i in attributes) {
                switch (defaults[i].type) {
                    ...
                    case 'font':
                        ...
                        $('#op_asset_browser_slide3 .op-settings-core-membership_order_button').trigger({type: 'update_button_preview', tag: 'membership_order_button', id: defaults[i].selector.substr(1), value: $item.attr('alt'), font_type: $item.attr('data-type'), font_family: $item.attr('data-family')});
                        break;
                    case 'slider':
