;(function($){
    ...
    function add_wysiwyg(id,content){
        ...
        var fragment, $fragment, $quicktagsToolbarPrev;
        ...
        if (use_wysiwyg) {
            ...
            if ( typeof QTags == 'function' ) {
                ...
                try {
                    ...
                    throw new Error('Error initializing quickatags.');
                }
            }
            ...
            if (tinyMCE.majorVersion > 3) {
                ...
                $quicktagsToolbarPrev = $('#qt_'+id+'_toolbar').prev();
                if ($quicktagsToolbarPrev.hasClass('mce-panel')) {
                    $quicktagsToolbarPrev.remove();
                }

                if (!window.op_tinymce_initialized) {
            ...
            // In live editor this is needed for edit elements.
