                    ...
                    events: {
                        change: function(value){
                            var el = $('#op_assets_core_optin_box_tabs_submit_button_button_content'),
                                ...
                                els = 'div.field-id-op_assets_core_optin_box_tabs_form_html_disable_name,\
div.field-id-op_assets_core_optin_box_tabs_form_html_name,\
div.field-input field-id-op_assets_core_optin_box_tabs_content_name_default',
                                els2 = 'div.field-id-op_assets_core_optin_box_tabs_content_headline,\
div.field-id-op_assets_core_optin_box_tabs_content_paragraph',
                                els3 = 'div.field-id-op_assets_core_optin_box_tabs_content_paragraph';
                                $selected_style = $('#op_asset_browser_slide2').find('.selected:visible'),
                            ...
                            if ($.inArray(style.toString(), no_extra_styles) >= 0) {
                                $('.field-id-op_assets_core_optin_box_tabs_form_html_extra_fields-multirow-container, .field-id-op_assets_core_optin_box_tabs_form_html_email_data_fields-multirow-container, .field-id-op_assets_core_optin_box_tabs_form_html_extra_fields, .field-id-op_assets_core_optin_box_tabs_form_html_email_data_fields').hide();
                            } else {
                                if ($('#op_assets_core_optin_box_tabs_form_html_integration_type').val() == 'email') {
                                    $('.field-id-op_assets_core_optin_box_tabs_form_html_email_data_fields-multirow-container, .field-id-op_assets_core_optin_box_tabs_form_html_email_data_fields').show();
                                } else {
                                    $('.field-id-op_assets_core_optin_box_tabs_form_html_extra_fields-multirow-container, .field-id-op_assets_core_optin_box_tabs_form_html_extra_fields').show();
                                }
                            }
                        }
                    }
                        ...
                        form_html: {
                            ...
                            fields: {
                                ...
                                list: {
                                    title: 'provider_list',
                                    type: 'select',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'emma', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']},
                                    events: {
                                        change: function(e) {
                                            /*
                                                ...
                                                if (typeof lists[e.currentTarget.value].fields == 'undefined') {
                                                    $.ajax({
                                                        ...
                                                        data: {
                                                            ...
                                                            'provider': $('#op_assets_core_optin_box_tabs_form_html_integration_type').val(),
                                                        ...
                                                        success: function(response) {
                                                            ...
                                                            && typeof lists[e.currentTarget.value].action != 'undefined') {
                                                                $('#op_assets_core_optin_box_tabs_form_html_action_page').val(lists[e.currentTarget.value].action);
                                                            }
                                                            /*
                                ...
                                double_optin: {
                                    title: 'double_optin',
                                    type: 'checkbox',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp']},
                                    default_value: true
                                },
                                thank_you_page: {
                                    title: 'thank_you_page_url',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'emma', 'aweber', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                action_page: {
                                    type: 'hidden',
                                ...
                                new_window: {
                                    title: 'new_window',
                                    type: 'checkbox',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email','custom','oneshoppingcart']}
                                },
                                email_address: {
                                    title: 'email_address',
                                    required: true,
                                ...
                                disable_name: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email', 'custom', 'oneshoppingcart', 'mailchimp', 'emma', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                name: {
                                    title: 'name',
                                    type: 'select',
                                ...
                                extra_fields: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['custom', 'oneshoppingcart', 'mailchimp', 'emma', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                no_extras: {
                                    type: 'paragraph',
            ...
            switch (attrs.form_html.integration_type) {
                ...
                case 'oneshoppingcart':
                    ...
                    $.each(attrs.form_html.extra_fields,function(i,v){
                        ...
                        if(name != ''){
                            nattrs['extra_field_'+counter+'_name'] = encodeURI(name);
                ...
                case 'infusionsoft':
                    ...
                    $.each(attrs.form_html.extra_fields,function(i,v){
                        ...
                        if(name != ''){
                            ...
                            nattrs['extra_field_'+counter+'_title'] = v.text;
                            nattrs['extra_field_'+counter+'_order'] = v.order;
                            nattrs['extra_field_'+counter + '_required'] = v.required || 'N';
                            used_fields.push(name);
                            counter++;
                        }
        ...
        customSettings: function(attrs,steps){
            ...
            switch (attrs.integration_type) {
                ...
                case 'emma':
                    ...
                    vals = {'email_order': ['email_order', 0], 'name_order': ['name_order', 0], 'integration_type': ['integration_type', 'custom'], 'name':['name_field', ''], 'list': ['list', ''], 'gotowebinar_list': ['gotowebinar', ''], 'thank_you_page': ['thank_you_page', '']};
                    break;
            }
            ...
            $('#'+idprefix+'form_html_new_window').attr('checked',((attrs.new_window || 'N') == 'Y'));
