...
class OptimizePress_Blog_Sharing_Module extends OptimizePress_Modules_Base {
	...
	function load_footer_scripts(){
		if($this->get_option('sharing','enabled') == 'Y'){
			echo '<script type="text/javascript">var switchTo5x=true;</script><script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script><script type="text/javascript">stLight.options({publisher:"f494318c-ebee-4740-a388-1ea04b0fa4e7"});</script>';
		}
	}
