...
(function($){
	$(document).ready(function(){
		$('.flowplayer').each(function(){
			...
			flowplayer($t.attr('id'),{src:OP.flowplayer,wmode:'opaque'},opts).ipad();
			//$(this).flowplayer(OP.flowplayer,opts).ipad();
		});
	});
})(opjq);