...
class OptimizePress_Blog_Continue_Reading_Module extends OptimizePress_Modules_Base {
    ...
    <div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
		<label for="op_<?php echo $section_name ?>_link_text" class="form-title"><?php _e('Link text',OP_SN) ?></label>
		<p class="op-micro-copy"><?php _e('Enter the Continue Reading link text for your blog.  To add arrows to your link use &amp;rarr;',OP_SN) ?></p>
