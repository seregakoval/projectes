<?php $file = ($item['type'] == 'file'); ?>
        	<li class="op-type-switcher-container">
            	<select name="<?php echo $fieldname ?>[type][]" class="op-type-switcher">
                	<option value="file"<?php echo $file ? ' selected="selected"':'' ?>><?php _e('File',OP_SN) ?></option>
                    <option value="url"<?php echo !$file ? ' selected="selected"':'' ?>><?php _e('URL',OP_SN) ?></option>
                </select>
                ...
                <div class="op-type op-type-url<?php echo $file ? ' op-disabled-type' : '' ?>">
	                <label for="<?php echo $id ?>imgurl_<?php echo $index ?>" class="form-title"><?php _e('URL:',OP_SN) ?></label>
                ...
                <label for="<?php echo $id ?>href_<?php echo $index ?>" class="form-title"><?php _e('Link to:',OP_SN) ?></label>
