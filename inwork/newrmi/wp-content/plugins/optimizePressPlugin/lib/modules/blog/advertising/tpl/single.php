        ...
        <label for="<?php echo $id ?>imgurl" class="form-title"><?php _e('Hosted elsewhere? Paste the link below',OP_SN) ?></label>
        ...
        <label for="<?php echo $id ?>href" class="form-title"><?php _e('Where do you wish this advertisement to link to?',OP_SN) ?></label>
