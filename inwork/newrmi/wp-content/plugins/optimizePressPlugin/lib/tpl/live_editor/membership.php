			...
			<div class="op-bsw-grey-panel-tab-content-container cf">
				<div class="op-bsw-grey-panel-tab-content tab-layout op-bsw-grey-panel-tab-content-selected">
					...
					<div class="op-bsw-grey-panel section-feature_title">
						<div class="op-bsw-grey-panel-header cf">
							<h3>
								<a href="#"><?php _e('DigitalAccessPass LiveLinks', OP_SN); ?></a>
							</h3>
							<div class="op-bsw-panel-controls cf">
								<div class="show-hide-panel">
									<a href="#"></a>
						...
						?>
						<div id="op_page_layout_footer_area" class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
							<p class="op-micro-copy"><?php _e('Customize DAP integration settings.',OP_SN) ?></p>
    						...
    						<p class="op-note"><em><?php _e('Note: Page protected with DAP will redirect to the URL specifed (if left empty, it will use global setting).',OP_SN) ?></em></p>
						</div>
					</div>
					<?php
					endif;
					...
					<div class="op-bsw-grey-panel section-feature_title">
						<div class="op-bsw-grey-panel-header cf">
							<h3>
								<a href="#"><?php _e('Fast Member', OP_SN); ?></a>
							</h3>
							<div class="op-bsw-panel-controls cf">
								<div class="show-hide-panel">
									<a href="#"></a>
						...
						?>
						<div id="op_page_layout_footer_area" class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
							<p class="op-micro-copy"><?php _e('Customize Fast Member integration settings.',OP_SN) ?></p>
    						...
    						<p class="op-note"><em><?php _e('Note: Page protected with Fast Member will redirect to the URL specifed (if left empty, it will use global setting).',OP_SN) ?></em></p>
						</div>
					</div>
					<?php
					endif;
					...
					<div class="op-bsw-grey-panel section-feature_title">
						<div class="op-bsw-grey-panel-header cf">
							<h3>
								<a href="#"><?php _e('iMember360', OP_SN); ?></a>
							</h3>
							<div class="op-bsw-panel-controls cf">
								<div class="show-hide-panel">
									<a href="#"></a>
						...
						?>
						<div id="op_page_layout_footer_area" class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
							<p class="op-micro-copy"><?php _e('Customize iMember360 integration settings.',OP_SN) ?></p>
    						...
    						<p class="op-note"><em><?php _e('Note: Page protected with iMember360 will redirect to the URL specifed (if left empty, it will use global setting).',OP_SN) ?></em></p>
						</div>
					</div>
					<?php
					endif;
					...
					<div class="op-bsw-grey-panel section-feature_title">
						<div class="op-bsw-grey-panel-header cf">
							<h3>
								<a href="#"><?php _e('Membership Page Settings', OP_SN); ?></a>
							</h3>
							<div class="op-bsw-panel-controls cf">
								<div class="show-hide-panel">
									<a href="#"></a>
							...
							<div id="pageType">
								...
								<select id="pageTypeChange" name="op[pageType][type]" disabled="disabled">
									...
									<option value="product"
										<?php echo $memType == 'product' ? 'selected="selected"': ''?>><?php _e('Product', OP_SN);?></option>
								...
								<a href="#" id="changeMembershipType"><?php _e('Change page type', OP_SN);?></a>
								<p class="microcopy"><?php _e('If you want to change the membership page type, click above link, then select page type that you want. Page will refresh and you can then change other options on this screen.', OP_SN);?></p>
							</div>
							<?php /*
							...
							<div id="content">
								<div style="clear: both;">
									...
									<select name="op[type]" id="op_type_id">
										...
										<option value="content"><?php _e('Content/lesson', OP_SN);?></option>
									</select>
								</div>
							</div>
							<?php endif; ?>
					...
					<div class="op-bsw-grey-panel section-feature_title">
						...
						<div id="op_page_layout_footer_area" class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
							<div style="clear: both;">
									<label><?php _e('Select membership type if you want to make this a membership page', OP_SN) ?></label>
									<p><?php _e('After this your page will refresh and you will have other options based on this selection in this screen.', OP_SN) ?></p>
