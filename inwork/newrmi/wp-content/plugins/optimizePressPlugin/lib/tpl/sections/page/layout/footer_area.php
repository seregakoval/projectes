...
<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf" id="op_page_layout_footer_area">
    <label for="op_footer_area_nav" class="form-title"><?php _e('Footer Navigation',OP_SN) ?></label>
    <p class="op-micro-copy"><?php _e('Select a source for the menu to be assigned to the footer links (next to the copyright message). Select none to show no menu',OP_SN) ?></p>
    <select id="op_footer_area_nav" name="op[footer_area][nav]"><option value=""><?php _e('None',OP_SN) ?></option>
    <?php
    ...
    <label for="op_footer_area_font" class="form-title"><?php _e('Select Navigation Bar Font (optional)',OP_SN) ?></label>
            <p class="op-micro-copy"><?php _e('If you would like to change the font for this navigation menu, you may change these settings below. We recommend using a menu with no more than five items on it.',OP_SN) ?></p>
		<?php
	...
	<div class="op-bsw-grey-panel section-large_footer">
		<div class="op-bsw-grey-panel-header cf">
			<h3><a href="#"><?php _e('Extra Large Footer',OP_SN) ?></a></h3>
        ...
        <div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
        	<label class="form-title"><?php _e('Extra Large Footer',OP_SN) ?></label>
            <p class="op-micro-copy"><?php _e('Activate this option if you want to have a larger footer area with space for you to add new elements using the LiveEditor',OP_SN) ?></p>
        </div>
    </div>
    <?php endif ?>
	<div class="op-bsw-grey-panel section-footer_disclaimer">
		<div class="op-bsw-grey-panel-header cf">
			<h3><a href="#"><?php _e('Footer Disclaimer',OP_SN) ?></a></h3>
        ...
        <div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
            <label for="op_footer_area_disclaimer_message" class="form-title"><?php _e('Disclaimer Override',OP_SN) ?></label>
            <p class="op-micro-copy"><?php _e('If you want to override the disclaimer message set in the OptimizePress general settings, enter a new disclaimer below. This disclaimer will be shown above the copyright message in your page footer.',OP_SN) ?></p>
