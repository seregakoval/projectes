    ...
    <div class="column-container">
		...
		for($i=1;$i<$max;$i++): ?>
			<div class="width-<?php echo $i ?>">
				<label for="<?php echo $fieldid.$i ?>" class="form-title"><?php printf(__('Column %1$s',OP_SN),$i) ?></label>
		    	<p class="op-micro-copy"><?php printf(__('Set the width for column %1$s of your blog footer.',OP_SN),$i).($i==1?_e(' This will be the left-most column',OP_SN):'') ?></p>
