...
<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf" id="op_page_layout_size_color">
    <label for="op_header_layout_box_color_start" class="form-title"><?php _e('Box background start colour', OP_SN); ?></label>
    <p class="op-micro-copy"><?php _e('Choose a box background start colour.', OP_SN); ?></p>
    <?php op_color_picker('op[size_color][box_color_start]', $box_color_start, 'op_size_color_box_color_start'); ?>
    <label for="op_header_layout_box_color_end" class="form-title"><?php _e('Box background end colour', OP_SN); ?></label>
    <p class="op-micro-copy"><?php _e('Choose a box background end colour.', OP_SN); ?></p>
    <?php op_color_picker('op[size_color][box_color_end]', $box_color_end, 'op_size_color_box_color_end'); ?>
    <label for="op_header_layout_box_width" class="form-title"><?php _e('Box width', OP_SN); ?></label>
    <p class="op-micro-copy"><?php _e('Enter box width in pixels.', OP_SN); ?></p>
