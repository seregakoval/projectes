<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
    ...
    <h3><?php _e('Choose From Our Pre-Existing Options',OP_SN) ?></h3>
    <p class="op-micro-copy"><?php _e('Select from the options available below to customise the colour schemes for your blog feature area and top navigation.',OP_SN) ?></p>
    <?php
    ...
    <h3><?php _e('Choose Your Color Settings',OP_SN) ?></h3>
    <?php endif;
