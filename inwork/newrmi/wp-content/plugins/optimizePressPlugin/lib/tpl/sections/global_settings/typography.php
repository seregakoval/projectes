<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar typography">
	<p><?php _e('Choose your page typography settings below. Please remember some fonts won\'t look right at smaller sizes, you can always click "Reset" to restore the page defaults at any time',OP_SN) ?></p>
    <?php
	...
	foreach($typography_elements['font_elements'] as $element => $title):
		...
		<li>
			...
			?>
				<a href="#reset" class="reset-link"><?php _e('Reset', OP_SN); ?></a>
			</div>
