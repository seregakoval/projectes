<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">
    <h4 class="form-title"><?php _e('Reset Content Templates',OP_SN) ?></h4>
    ...
    <div class="clear"></div>
    <h4><?php _e('Content Templates List', OP_SN); ?></h4>
    <p class="op-micro-copy"><?php _e('List of all content templates, both predefined and custom, with ability to delete them.', OP_SN); ?></p>
    <?php 
	...
	<div class="op-content-layout-category">
		...
		<div class="img-radio-item" style="width:196px;">
	        ...
	        <a href="#content-layout-<?php echo $layout->id; ?>" onclick="return confirm('<?php _e('Are you sure you want to delete this layout?', OP_SN); ?>');" class="op-js-item-layout-delete" data-id="<?php echo $layout->id; ?>" data-nonce="<?php echo $ajaxNonce; ?>"><?php _e('Delete', OP_SN); ?></a>
	    </div>
	    <?php endforeach; ?>
	    <div class="clear"></div>
	</div>
