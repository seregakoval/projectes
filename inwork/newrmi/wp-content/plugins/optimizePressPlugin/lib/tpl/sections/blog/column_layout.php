    ...
    <div class="column-container">
		...
		foreach($fields as $name => $field): ?>
			<div class="width-<?php echo $name ?>">
				<label for="<?php echo $fieldid.$name ?>" class="form-title"><?php _e($field['title'],OP_SN) ?></label>
				<p class="op-micro-copy"><?php printf(__('Enter the width of your sidebar. Enter a value between %1$s and %2$s or click Default to restore default setting',OP_SN),op_get_var($field,'min',230),op_get_var($field,'max',400)); ?></p>
