<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar typography">
	<p><?php _e('Choose your theme typography settings below. Please remember some fonts won\'t look right at smaller sizes, you can always click "Reset" to restore the theme defaults at any time',OP_SN) ?></p>
    <?php
