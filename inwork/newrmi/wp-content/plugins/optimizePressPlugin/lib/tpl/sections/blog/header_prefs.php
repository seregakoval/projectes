...
<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
	<p class="op-micro-copy"><?php printf(__('Choose the layout for your Blog header from the options below.  Remember to create and assign menus to your blog Menus within the %1$sWordpress Menus admin panel%2$s', OP_SN),'<a href="nav-menus.php">','</a>') ?></p>
	<?php
	...
	<div class="op-bsw-grey-panel section-top">
		<div class="op-bsw-grey-panel-header cf">
			<h3><a href="#"><?php _e('Blog Primary Navigation', OP_SN); ?></a></h3>
		...
		<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
			<div id="layout-settings-alongside" class="link-color-container cf layout-settings"<?php echo ($name=='alongside' ? '':' style="display:none"')?>>
				<label for="op_sections_header_prefs_alongside_nav_font" class="form-title"><?php _e('Select Navigation Bar Font (optional)',OP_SN) ?></label>
				...
				echo _op_fonts('font_size_dropdown', 'op[sections][header_prefs][alongside_nav_font_size]', $font_size, 'op_sections_header_prefs_alongside_nav_font_size', '');
				echo _op_fonts('font_style_dropdown', 'op[sections][header_prefs][alongside_nav_font_weight]', $font_weight, 'op_sections_header_prefs_alongside_nav_font_weight', '');
				echo _op_fonts('font_shadow_dropdown', 'op[sections][header_prefs][alongside_nav_font_shadow]', $font_shadow, 'op_sections_header_prefs_alongside_nav_font_shadow', '');
				?>
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_nav_link" class="form-title"><?php _e('Navigation Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the colour for the main text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_nav_hover_link" class="form-title"><?php _e('Navigation Hover Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the hover colour for the main text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_nav_bg_hover" class="form-title"><?php _e('Navigation Background Hover',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the hover background colour for your main navigation bar (this will be used for the background hover state)', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_dd_link" class="form-title"><?php _e('Dropdown Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_dd_hover_link" class="form-title"><?php _e('Dropdown Hover Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the hover colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_dd_bg" class="form-title"><?php _e('Dropdown Background',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the  colour for your dropdown menu background.', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_alongside_dd_bg_hover" class="form-title"><?php _e('Dropdown Background Hover',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the background colour for the hover state of child pages in your navigation bar', OP_SN); ?></p>
			...
			<div id="layout-settings-below"<?php echo ($name=='below' ? '':' style="display:none"')?> class="link-color-container cf layout-settings">
				<label for="op_sections_header_prefs_below_nav_font" class="form-title"><?php _e('Select Navigation Bar Font (optional)',OP_SN) ?></label>
				<p class="micro-copy">If you would like to change the font for this navigation menu, you may change these settings below.</p>
				<?php
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_nav_link" class="form-title"><?php _e('Navigation Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the colour for the main text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_nav_hover_link" class="form-title"><?php _e('Navigation Hover Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the hover colour for the main text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_bg_start" class="form-title"><?php _e('Background (Gradient Start Colour)',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the start (top) colour for the gradient on your navigation bar. For a solid colour leave the end colour blank', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_bg_end" class="form-title"><?php _e('Background (Gradient End Colour)',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the end (bottom) colour for the gradient on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_bg_hover_start" class="form-title"><?php _e('Background Hover (Gradient Start Colour)',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the hover start (top) colour for the gradient on your main navigation bar. For a solid colour leave the end colour blank', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_bg_hover_end" class="form-title"><?php _e('Background Hover (Gradient End Colour)',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the hover end (bottom) colour for the gradient on your main navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_dd_link" class="form-title"><?php _e('Dropdown Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_dd_hover_link" class="form-title"><?php _e('Dropdown Hover Link Text',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the hover colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_dd_bg" class="form-title"><?php _e('Dropdown Background',OP_SN) ?></label>
					<p class="op-micro-copy"><?php _e('Choose the  colour for your dropdown menu background.', OP_SN); ?></p>
				...
				<br style="clear: left;" />
				<div class="color-chooser">
					<label for="op_sections_header_prefs_below_dd_bg_hover" class="form-title"><?php _e('Dropdown Background Hover',OP_SN) ?></label>
					<p class="micro-copy"><?php _e('Choose the background colour for the hover state of child pages in your navigation bar', OP_SN); ?></p>
	...
	<div class="op-bsw-grey-panel section-bottom">
		<div class="op-bsw-grey-panel-header cf">
			<h3><a href="#"><?php _e('Blog Top Navigation', OP_SN); ?></a></h3>
			<div class="op-bsw-panel-controls cf">
				<div class="panel-control"></div>
				<div class="show-hide-panel"><a href="#"></a></div>
			</div>
		...
		<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
			<label for="op_sections_color_scheme_fields_top_nav_font" class="form-title"><?php _e('Select Navigation Bar Font (optional)',OP_SN) ?></label>
			<p class="micro-copy">If you would like to change the font for this navigation menu, you may change these settings below.</p>
			<?php
			...
			?>
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_fields_top_nav_color" class="form-title"><?php _e('Top Navigation Background Color',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Select or enter a colour for the top navigation bar background colour', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_fields_link_color" class="form-title"><?php _e('Top Navigation Link Color',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Select or enter a colour for the text link in the top navigation bar', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_field_top_nav_hover_link" class="form-title"><?php _e('Navigation Hover Link Text',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Choose the hover colour for the main text links on your navigation bar', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_fields_top_nav_dd_link" class="form-title"><?php _e('Dropdown Link Text',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Choose the colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_fields_top_nav_dd_hover_link" class="form-title"><?php _e('Dropdown Hover Link Text',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Choose the hover colour for the dropdown text links on your navigation bar', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_fields_top_nav_dd" class="form-title"><?php _e('Dropdown Background',OP_SN) ?></label>
			<p class="op-micro-copy"><?php _e('Choose the colour for your dropdown menu background.', OP_SN); ?></p>
			...
			<br style="clear: left;" />
			<label for="op_sections_color_scheme_field_top_nav_dd_hover" class="form-title"><?php _e('Dropdown Background Hover',OP_SN) ?></label>
			<p class="micro-copy"><?php _e('Choose the background colour for the hover state of child pages in your navigation bar', OP_SN); ?></p>
