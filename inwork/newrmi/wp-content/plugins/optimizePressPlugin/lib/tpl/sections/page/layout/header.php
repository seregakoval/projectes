...
<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf" id="op_page_layout_header">
	...
	<div class="op-header-disable-link">
	    <label for="op_header_disable_link" class="form-title"><?php _e('Remove link on header/logo',OP_SN) ?></label>
	    <p class="op-micro-copy"><?php _e('If this is checked, no link will be added to your page header/logo',OP_SN); ?></p>
	    <input type="checkbox" name="op[header_layout][disable_link]" id="op_header_disable_link" <?php echo ($header_layout['disable_link'] == 'on') ? 'checked="checked"' : ''; ?> /> <label for="op_header_disable_link" class="disable_header_link"><?php _e('Remove link on header/logo',OP_SN) ?></label>
	</div>
	
	<div class="op-header-link" id="op_header_link">
	    <label for="op_header_link" class="form-title"><?php _e('Edit header/logo link',OP_SN) ?></label>
	    <p class="op-micro-copy"><?php _e('Here you can edit the header/logo link',OP_SN); ?></p>
	...
	<div class="op-bsw-grey-panel section-nav_bar_above">
        ...
        <div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar">
            ...
            <p class="op-micro-copy"><?php _e('If you want to show a small logo in your navigation bar, upload it here. Ensure the logo is in transparent PNG format and no larger than 100x40px',OP_SN) ?></p>
