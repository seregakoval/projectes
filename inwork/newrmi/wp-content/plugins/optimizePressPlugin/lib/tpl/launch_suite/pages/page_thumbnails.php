<?php $conf = op_get_var($config,'page_thumbnails') ?><label class="form-title"><?php _e('Page Thumbnail',OP_SN) ?></label>
...
<label class="form-title"><?php _e('Coming Soon Thumbnail',OP_SN) ?></label>
