...
<div class="op-bsw-grey-panel op-bsw-grey-panel-no-content">
	<div class="op-bsw-grey-panel-header cf">
		<h3><?php _e('Open Sales Cart',OP_SN) ?></h3>
...
<div class="op-bsw-grey-panel op-bsw-grey-panel-no-content" id="hide_cart">
	<div class="op-bsw-grey-panel-header cf">
	<h3><?php _e('Hide Cart Link',OP_SN) ?></h3>
		<div class="op-bsw-panel-controls cf">
            <?php
...
<label class="form-title"><?php _e('Sales Page / Offer Page',OP_SN) ?></label>
...
<label class="form-title"><?php _e('Page URL',OP_SN) ?></label>
<p class="op-micro-copy"><?php _e('If the cart is open this will display the cart page, otherwise will show the most recent funnel stage',OP_SN) ?></p>
...
<div class="gateway_on">
    <label class="form-title"><?php _e('Early Bird Access URL',OP_SN) ?></label>
    <p class="op-micro-copy"><?php _e('Use this link to give your visitors access to your sales page even if the sales cart is set to closed.',OP_SN) ?></p>
