		...
		<div class="op-pb-header cf">
			<div class="op-pb-fixed-width">
					...
					<div class="op-pb-steps">
		                    ...
		                    $steps = array(
		                        array(
		                            'step_text' => __('Create Page', OP_SN),
		                            'step_desc' => __('Create your new page and choose a page name', OP_SN),
		                        ),
		                        array(
		                            'step_text' => __('Page Type', OP_SN),
		                            'step_desc' => __('Choose a page type for your page', OP_SN),
		                        ),
		                        array(
		                            'step_text' => __('Template', OP_SN),
		                            'step_desc' => __('Choose a template for your page', OP_SN),
		                        ),
		                        array(
		                            'step_text' => __('Settings', OP_SN),
		                            'step_desc' => __('Customize the settings for your chosen template', OP_SN),
		                        ),
		                        array(
		                            'step_text' => '',
		                            'step desc' => '',
		                    ...
		                    foreach($steps as $step => $text){
		                        ...
		                        if ($num == 3 && (isset($page_type) && $page_type == 'membership')) {
		                        	$text['step_text'] = __('Membership', OP_SN);
		                        	$text['step_desc'] = __('Choose your membership options', OP_SN);
		                        }
		                        $selected = false;
		                        if($num == $cur_step){
		                            $selected = true;
