...
/**
 * OP_GetResponse Class
 * @package GetResponsePHP
 */
class OP_GetResponse
{
    /**
     * GetResponse API key
     ...
     * @return void
     */
    public function __construct($apiKey = null, $apiUrl = null, OptimizePress_Modules_Email_LoggerInterface $logger)
    {
        ...
        if (null !== $apiUrl ) $this->apiUrl = $apiUrl;
    ...
    /**
     * Get custom fields on account level
     * Account is determined by API key
     * @return object
     */
    public function getAccountCustoms()
    {
        $request  = $this->prepRequest('get_account_customs');
        $response = $this->execute($request);
        return $response;
    }
