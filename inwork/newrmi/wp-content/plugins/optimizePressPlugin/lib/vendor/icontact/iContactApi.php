...
class OP_iContactApi {
     ...
     * @static
     * @access public
     * @param OP_iContactApi $oInstance Instance to set to
     * @return OP_iContactApi $this
    **/
     ...
     * @return OP_iContactApi $this
    **/
    public static function getInstance(OptimizePress_Modules_Email_LoggerInterface $logger) {
        // Check to see if an instance has already
        // been created
        if (is_null(self::$oInstance)) {
            // If not, return a new instance
            self::$oInstance = new self($logger);
            return self::$oInstance;
        } else {
    ...
    **/
     ...
     * @return OP_iContactApi $this
    **/
    protected function __construct(OptimizePress_Modules_Email_LoggerInterface $logger) {
        /*
         * Initializing logger
         */
        $this->logger = $logger;
