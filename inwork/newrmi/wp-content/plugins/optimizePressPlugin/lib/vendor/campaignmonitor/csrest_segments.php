 ...
 *
 */
class OP_CS_REST_Segments extends OP_CS_REST_Wrapper_Base {
     ...
     *             )
     *         )
     * @return OP_CS_REST_Wrapper_Result A successful response will be the ID of the newly created segment
     */
