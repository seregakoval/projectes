 ...
 *
 */
class OP_CS_REST_Templates extends OP_CS_REST_Wrapper_Base {
     ...
     *         )
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be the ID of the newly created template
     */
