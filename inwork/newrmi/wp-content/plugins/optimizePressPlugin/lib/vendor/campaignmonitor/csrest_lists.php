 ...
 *
 */
class OP_CS_REST_Lists extends OP_CS_REST_Wrapper_Base {
     ...
     * @param $log OP_CS_REST_Log The logger to use. Used for dependency injection
     * @param $serialiser The serialiser to use. Used for dependency injection
     * @param $transport The transport to use. Used for dependency injection
     * @access public
     */
    function OP_CS_REST_Lists (
    $list_id,
    $auth_details,
    $protocol = 'https',
    ...
    $transport = NULL) {
        ...
        $this->OP_CS_REST_Wrapper_Base($auth_details, $protocol, $debug_level, $host, $log, $serialiser, $transport);
     ...
     *     )
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be the ID of the newly created list
     */
     ...
     *     )
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be empty
     */
     ...
     *     )
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be the 
     ...
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be an object of the form
     * array(
     *     {
     ...
     *     )
     * @access public
     * @return OP_CS_REST_Wrapper_Result A successful response will be the ID of the newly created webhook
     */
