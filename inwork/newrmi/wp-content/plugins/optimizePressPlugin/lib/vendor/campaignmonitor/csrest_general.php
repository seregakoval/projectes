 ...
 *
 */
class OP_CS_REST_General extends OP_CS_REST_Wrapper_Base {
    ...
    public static function exchange_token(
        ...
        $wrap = new OP_CS_REST_Wrapper_Base(
            NULL, 'https', CS_REST_LOG_NONE, CS_HOST, NULL,
            new OP_CS_REST_DoNothingSerialiser(), NULL);
     ...
     * @access public
     */
    function OP_CS_REST_Wrapper_Base(
        $auth_details,
        $protocol = 'https',
    ...
    function get_lists() {
        return $this->get_request($this->_base_route.'lists.json');   
    }
     ...
     * @return OP_CS_REST_Wrapper_Result a successful response will be an array in the form:
     ...
     *
     * @return OP_CS_REST_Wrapper_Result A successful response will be an array of the form:
