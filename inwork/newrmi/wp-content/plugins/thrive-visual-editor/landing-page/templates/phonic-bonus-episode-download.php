...
<div class="tve_lp_content tve_editor_main_content tve_empty_dropzone tve_content_width">
								...
								<div class="thrv_wrapper thrv_content_container_shortcode">
									...
									<div class="tve_center tve_content_inner"
										...
										<h1 style="color: #fff; font-size: 60px;margin-top: 0;margin-bottom: 0;"
											...
											Thank You for <span class="bold_text"><font color="#fdd657">Signing
													Up!</font></span><br> Listen to the <span class="bold_text">Bonus Episode Below:</span>
										</h1>
									</div>
									<div class="tve_clear"></div>
								</div>
	...
	<h2 class="tve_p_center rft" style="color: #1399bc; font-size: 42px;margin-top: 0;margin-bottom: 10px;">
		Did you enjoy this episode?
	</h2>
	<h5 class="tve_p_center" style="color: #333; font-size: 24px;margin-top: 0;margin-bottom: 40px;">
				...
				<div class="cck clearfix">
					<div class="thrv_wrapper thrv_content_container_shortcode">
						...
						<div class="tve_center tve_content_inner" style="width: 931px;min-width:50px; min-height: 2em;">
									...
									<div class="tve_cb_cnt">
										<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
											<div class="tve_colm tve_oth">
												<p style="color: #666666; font-size: 24px;margin-top: 22px;margin-bottom: 0;">
													Leave a Review on:
												</p>
											</div>
											<div class="tve_colm tve_oth">
												<div style="width: 178px;margin-top: 7px;margin-bottom: 0;margin-right: 0;" class="thrv_wrapper tve_image_caption alignleft">
                                                    <span class="tve_image_frame">
                                                        <img class="tve_image"
                                                             src="<?php echo TVE_LANDING_PAGE_TEMPLATE . '/css/images/phonic_itunes.png' ?>"
                                                             style="width: 178px;"/>
                                                    </span>
												</div>
												<div style="width: 70px;margin-top: 7px;margin-bottom: 0;margin-right: 0;" class="thrv_wrapper tve_image_caption alignleft">
                                                    <span class="tve_image_frame">
                                                        <img class="tve_image phonic-arrows"
												...
												<div class="thrv_wrapper thrv_button_shortcode" data-tve-style="1">
                                                    ...
                                                    <span class="tve_left tve_btn_im">
                                                        ...
                                                        <span class="tve_btn_divider"></span>
															...
															<span class="tve_btn_txt">WRITE A REVIEW</span>
														</a>
													</div>
												</div>
											</div>
							...
							<div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="symbol">
								<div class="tve_cb tve_cb_symbol tve_white" style="margin-bottom: 60px;">
									<div class="thrv_wrapper thrv_icon thrv_cb_text aligncenter tve_no_drag tve_no_icons" style="font-size: 40px;">
									...
									<div class="tve_cb_cnt">
										<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
											...
											<div class="tve_colm tve_oth">
												<div style="width: 178px;margin-top: -1px;margin-bottom: 0;margin-right: 0;" class="thrv_wrapper tve_image_caption alignleft">
                                                    <span class="tve_image_frame">
                                                        <img class="tve_image"
                                                             src="<?php echo TVE_LANDING_PAGE_TEMPLATE . '/css/images/phonic_stitcher.png' ?>"
                                                             style="width: 178px;"/>
                                                    </span>
												</div>
												<div style="width: 70px;margin-top: 7px;margin-bottom: 0;margin-right: 0;" class="thrv_wrapper tve_image_caption alignleft">
