				...
				<div class="cck tve_clearfix">
					<div class="thrv_wrapper thrv_columns tve_clearfix">
						<div class="tve_colm tve_tth">
							...
							<p style="color: #fff;font-size: 18px;margin-top: 0;margin-bottom: 10px;">To make sure we don’t send emails to the wrong address, we
		...
		<div class="tve_colm tve_thc tve_lst">
			...
			<div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
				<div class="tve_cb tve_cb5 tve_white">
					<div class="tve_cb_cnt">
						<p style="color: #545454; font-size: 18px;margin-top: 0;margin-bottom: 0;">
							Once you’ve clicked the confirmation link, you’re <span class="bold_text">done!</span> You will be taken directly to your download.
						</p>
					</div>
				</div>
			</div>
