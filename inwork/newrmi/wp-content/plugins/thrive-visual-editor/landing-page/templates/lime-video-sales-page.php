		...
		<div class="out" style="background-color: #68bf61">
			<div class="in">
				<div class="cck tve_clearfix">
					<div style="width: 189px;margin-top: 50px;margin-bottom: 50px;"
					...
					<h1 class="tve_p_center"
						...
						Watch the video to see how simple effective, traffic-driving content can really be:
					</h1>
					<p class="tve_p_center" style="color: #fff; font-size: 18px;margin-top: 0;margin-bottom: 20px;">
						<span class="bold_text">Watch the video</span> above to see how simple effective,
						traffic-driving content can really be
					</p>
					...
					<div class="thrv_wrapper thrv_content_container_shortcode">
						...
						<div class="tve_center tve_content_inner"
							...
							<div class="thrv_responsive_video thrv_wrapper" data-type="youtube" data-rel="0"
							     ...
							     data-url="https://www.youtube.com/watch?v=jbv4EAoqFXQ&amp;list=UUuL6ZEN9ZF-8C5s8HlcdoyQ"
							     data-embeded-url="//www.youtube.com/embed/jbv4EAoqFXQ"
							     data-modestbranding="1">
								<div style="display: block;" class="tve_responsive_video_container">
									<div class="video_overlay"></div>
									<iframe frameborder="0" allowfullscreen=""
									        src="//www.youtube.com/embed/jbv4EAoqFXQ?rel=0&amp;modestbranding=1&amp;controls=0&amp;showinfo=0&amp;autoplay=0&amp;fs=1&amp;wmode=transparent"></iframe>
								</div>
							</div>
						</div>
						<div class="tve_clear"></div>
		...
		<div class="tve_center tve_content_inner"
			...
			<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin: 0;">
				<div class="tve_colm tve_oth">
					...
					<p style="color: #898989;font-size: 14px;margin-top: 6px;margin-bottom: 0;">100% Money Back</p>
				</div>
				<div class="tve_colm tve_oth">
					...
					<p class="tve_p_right" style="color: #898989; font-size: 15px;margin-top: 10px;margin-bottom: 0;">
						Secure Checkout</p>
				</div>
