<div class="tve_cpanel_sec" id="tve_page_actions">
	<div class="tve_ed_btn tve_btn_icon tve_left">
		<div class="tve_icm tve-ic-undo tve-disabled" id="tve_undo_manager" title="<?php echo __( "Undo last action", 'thrive-cb' ) ?>"></div>
	</div>
	<div class="tve_ed_btn tve_btn_icon tve_left tve_expanded">
		<div class="tve_icm tve-ic-redo tve-disabled" id="tve_redo_manager" title="<?php echo __( "Redo last action", "thrive-cb" ) ?>"></div>
	</div>
	...
	<div class="tve_ed_btn tve_btn_icon tve_left" title="Save page content">
		<div class="tve_icm tve-ic-toggle-down tve_click tve_lb_small" data-ctrl="controls.lb_open" id="lb_save_user_template" title="<?php echo __( "Save page content as template", "thrive-cb" ) ?>"></div>
	</div>
			...
			<div class="tve_sub_btn">
				<div class="tve_sub active_sub_menu" id="tve_global_page_settings">
					<ul>
						...
						<?php endif ?>
						<li id="tve_flipEditor" class="tve_click" data-skip-undo="1" data-ctrl="controls.click.flip_editor"><?php echo __( "Switch Editor Side", "thrive-cb" ) ?></li>
						<li id="tve_flipColor" class="tve_click" data-skip-undo="1" data-ctrl="controls.click.flip_editor_color"><?php echo __( "Change Editor Color", 'thrive-cb' ) ?></li>
