...
var wpAjaxUrl='http://koval.urich.org/africa/wp-admin/admin-ajax.php';var flBuilderUrl='http://koval.urich.org/africa/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://koval.urich.org/africa/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://koval.urich.org/africa/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var body=$('body');if(!body.hasClass('archive')&&$('.fl-builder-content-primary').length>0){body.addClass('fl-builder');}
