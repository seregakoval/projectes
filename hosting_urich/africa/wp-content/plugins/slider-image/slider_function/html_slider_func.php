...
function print_html_nav($count_items,$page_number,$serch_fields=""){
  ...
  <?php if (isset($_POST['page_number']))  {
	...
	<input type="hidden" id="page_number" name="page_number" value="<?php  echo $pagenumber ?>"  />
  ...
  <?php 
	...
	<input type="hidden" id="page_number" name="page_number" value="1"  />
			...
			$serach_or_not = esc_html($_POST["serch_or_not"]);
  ?>
    <input type="hidden" id="serch_or_not" name="serch_or_not" value="<?php echo $serach_or_not  ?>"    />
 
 <?php }
 else { ?>
 
     <input type="hidden" id="serch_or_not" name="serch_or_not" value=""    />
