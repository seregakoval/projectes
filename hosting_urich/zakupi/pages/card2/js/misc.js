$(document).ready(function(){
	$('.search-icon').click(function(){
		$(".hide-block").toggleClass('show-b');
	});
	/*$(".tab_content").hide(); //скрыть весь контент
	$(".ul-tabs li:last").addClass("active").show(); //Активировать первую вкладку
	$(".tab_content:last").show(); //Показать контент первой вкладки
...
$(function(){
  ...
  if($('.fc2desc .line select').length){
		$('.fc2desc .line select').styler();
	}
