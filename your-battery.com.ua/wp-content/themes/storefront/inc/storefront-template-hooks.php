...
add_action( 'storefront_headernav', 'storefront_secondary_navigation',             30 );
add_action( 'storefront_headernav', 'storefront_primary_navigation_wrapper',       42 );
add_action( 'storefront_headernav', 'storefront_primary_navigation',               50 );
add_action( 'storefront_headernav', 'storefront_primary_navigation_wrapper_close', 68 );
...
add_action( 'homepage-main', 'storefront_product_categories',    20 );
...
add_action( 'homepage', 'storefront_popular_products',      50 );
    /**/
add_action( 'homepage-main', 'storefront_popular_products',      50 );
    /**/
