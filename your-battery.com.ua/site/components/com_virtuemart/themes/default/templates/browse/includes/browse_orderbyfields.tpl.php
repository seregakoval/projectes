...
// SORT BY PRODUCT NAME
if( in_array( 'product_starting', $VM_BROWSE_ORDERBY_FIELDS)) { ?>
        <option value="product_starting" <?php echo $orderby=="product_starting" ? "selected=\"selected\"" : "";?>>
        <?php echo $VM_LANG->_('PHPSHOP_PRODUCT_FORM_STARTING_ORDERBY') ?></option>
<?php
}
