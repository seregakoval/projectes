...
foreach( $categories as $category ) {
	...
	<td align="center" width="<?php echo $cellwidth ?>%" >
		<br />
         <a style="text-decoration:none;" title="<?php echo $category["category_name"] ?>" href="<?php $sess->purl(URL."index.php?option=com_virtuemart&amp;page=shop.browse&amp;category_id=".$category["category_id"]) ?>"> 
			<?php
