...
class vm_ps_product extends vmAbstractObject {
	...
	function add( &$d ) {
		...
		$fields = array ( 'vendor_id' => $vendor_id,
                        ...
                        'product_capacity' => vmRequest::getFloat('product_capacity'),
                        'product_starting' => vmRequest::getInt('product_starting'),
                        'product_voltage' => vmRequest::getInt('product_voltage'),
