	...
	<tr> 
   		<td valign="top">
			<table width="100%" border="0">
                ...
                <!--pusk i emkost` for AKB-->
    			<tr class="row0"> 
      				<td width="21%"><div style="text-align:right;font-weight:bold;">
      					<?php echo $VM_LANG->_('PHPSHOP_PRODUCT_FORM_PRODUCT_VOLTAGE') ?>:</div>
      				</td>
      				<td width="79%"> 

                        <?php 
                    if ($db->sf("product_voltage")=="6") { 
      					echo "6v <input type=\"radio\" name=\"product_voltage\" value=\"6\" checked=\"checked\" /> ";
      				}
                    else {
                        echo "6v <input type=\"radio\" name=\"product_voltage\" value=\"6\"/> ";
                    }
                    
                    if ($db->sf("product_voltage")=="12"){
      					echo "12v <input type=\"radio\" name=\"product_voltage\" value=\"12\" checked=\"checked\" /> ";
      				}
                    else {
                        echo "12v <input type=\"radio\" name=\"product_voltage\" value=\"12\"/> ";
                    }
                    
                    if ($db->sf("product_voltage")=="24"){
      					echo "24v <input type=\"radio\" name=\"product_voltage\" value=\"24\" checked=\"checked\" /> ";
      				}
                    else {
                        echo "24v <input type=\"radio\" name=\"product_voltage\" value=\"24\"/> ";
                    }
                    ?>
    			...
    			<tr class="row0"> 
      				<td width="21%"><div style="text-align:right;font-weight:bold;">
      					<?php echo $VM_LANG->_('PHPSHOP_PRODUCT_FORM_PRODUCT_CAPACIY') ?>:</div>
      				</td>
      				<td width="79%"> 
        				<input type="text" class="inputbox"  name="product_capacity" value="<?php echo shopMakeHtmlSafe( $db->sf("product_capacity")); ?>" size="5" maxlength="4" />
      				</td>
    			</tr>
    			
                <tr class="row0"> 
      				<td width="21%"><div style="text-align:right;font-weight:bold;">
      					<?php echo $VM_LANG->_('PHPSHOP_PRODUCT_FORM_PRODUCT_STARTING') ?>:</div>
      				</td>
      				<td width="79%"> 
        				<input type="text" class="inputbox"  name="product_starting" value="<?php echo shopMakeHtmlSafe( $db->sf("product_starting")); ?>" size="5" maxlength="4" />
      				</td>
    			</tr>
                <!--pusk i emkost` for AKB-->
