...
define( 'URL', 'http://your-battery.com.ua/' );
define( 'SECUREURL', 'http://your-battery.com.ua/' );
...
define('PSHOP_OFFLINE_MESSAGE', 'Извините, сайт в стадии наполнения продукции...');
...
define('DOWNLOADROOT', 'D:\XAMPP\htdocs\your-battery/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', 'b4f5a82be53fd5ad5d62f12b8f80754a');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
