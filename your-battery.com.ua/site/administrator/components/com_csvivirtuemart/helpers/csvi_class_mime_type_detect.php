...
* @version $Id: csvi_class_mime_type_detect.php 1117 2010-01-01 21:39:52Z Roland $
 */
...
class MimeTypeDetect {
	...
	* Load all mime type signatures
	...
	private function LoadMimeTypes() {
		...
		$this->mime_types[84]['signature'] = 'FFD8FFFE';
		$this->mime_types[85]['signature'] = 'FFD8FFE0';
		$this->mime_types[86]['signature'] = 'FFD8FFE1';
		$this->mime_types[87]['signature'] = '474946383961';
		...
		$this->mime_types[86]['extension'] = '.jpeg;.jpe;.jpg';
		$this->mime_types[87]['extension'] = '.gif';
		...
		$this->mime_types[5]['description'] = 'xtended (Enhanced) Windows Metafile Format';
		...
		$this->mime_types[13]['description'] = 'Registry Data File';
		$this->mime_types[14]['description'] = 'Rich Text Format File';
		$this->mime_types[15]['description'] = 'Lzh compression file';
		$this->mime_types[16]['description'] = 'Musical Instrument Digital Interface MIDI-sequention Sound';
		$this->mime_types[17]['description'] = 'PC Paintbrush Bitmap Graphic';
		...
		$this->mime_types[86]['description'] = 'JPG Graphic File';
		$this->mime_types[87]['description'] = 'GIF 89A';
		
		// Mime descriptions
		$this->mime_types[0]['mime_type'] = 'image/gif';
		$this->mime_types[1]['mime_type'] = 'image/bmp';
		$this->mime_types[2]['mime_type'] = '';
		$this->mime_types[3]['mime_type'] = '';
		$this->mime_types[4]['mime_type'] = '';
		...
		$this->mime_types[14]['mime_type'] = '';
		$this->mime_types[15]['mime_type'] = '';
		$this->mime_types[16]['mime_type'] = '';
		...
		$this->mime_types[51]['mime_type'] = '';
		$this->mime_types[52]['mime_type'] = '';
		...
		$this->mime_types[62]['mime_type'] = '';
		$this->mime_types[63]['mime_type'] = '';
		...
		$this->mime_types[86]['mime_type'] = 'image/jpeg';
		$this->mime_types[87]['mime_type'] = 'image/gif';
	}
	
	private function LoadImageTypes() {
		$this->image_types[0]['mime_type'] = 'image/gif';
		$this->image_types[1]['mime_type'] = 'image/bmp';
		$this->image_types[2]['mime_type'] = 'image/png';
		$this->image_types[3]['mime_type'] = 'image/jpeg';
		$this->image_types[4]['mime_type'] = 'image/jpeg';
		$this->image_types[5]['mime_type'] = 'image/gif';
	}
	...
	* @return string|bool return mime type if found | return false if no type found
	...
	public function FindMimeType($filename) {
		...
		if (JFile::exists($filename)) {
			...
			fclose($handle);
			if (isset($this->found_mime_type['mime_type'])) return $this->found_mime_type['mime_type'];
			else return false;
		}
		else return false;
	}
	...
	/**
	* Checks if the current file is an image file
	*
	* @return integer 1 for image type | 0 if no image type has been found
	 */
	public function CheckImage($mime_type) {
		foreach ($this->image_types as $key => $type) {
			if ($type['mime_type'] == $mime_type) return 1;
		}
