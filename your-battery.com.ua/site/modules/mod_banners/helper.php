...
class modBannersHelper
{
	...
	function renderBanner($params, &$item)
	{
		...
		else if (BannerHelper::isFlash( $item->imageurl ))
		{
			...
			$html =	"<object wmode=\"opaque\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0\" border=\"0\" width=\"$width\" height=\"$height\">
						<param name=\"wmode\" value=\"opaque\"><param name=\"movie\" value=\"$imageurl\"><param NAME=wmode VALUE=transparent><embed wmode=\"opaque\" src=\"$imageurl\" loop=\"false\" pluginspage=\"http://www.macromedia.com/go/get/flashplayer\" type=\"application/x-shockwave-flash\" width=\"$width\" height=\"$height\"></embed>
					</object>";
		}
