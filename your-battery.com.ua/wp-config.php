...
define('DB_NAME', 'sergey70_battery');  //wp-restyle



/** MySQL database username */

define('DB_USER', 'sergey70_battery');       //user



/** MySQL database password */

define('DB_PASSWORD', 'dqt8luhn'); //11111



/** MySQL hostname */

define('DB_HOST', 'sergey70.mysql.ukraine.com.ua');
